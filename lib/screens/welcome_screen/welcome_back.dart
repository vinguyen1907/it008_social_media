    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned(
            top: height_variable*0.518,
            left: width_variable*0.208,
            child: Text(
              'We have sent a new message to\nyour email.Please check your\nemail to restore your account!',
              style: TextStyle(fontFamily: 'Poppins-Regular', fontWeight: FontWeight.w500, fontSize: height_variable*0.017),
            ),
